...
class LogicMonitor(object):
    ...
    def rpc(self, action, params):
        ...
        creds = urllib.urlencode({"c": self.company, "u": self.user, "p": self.password})
        if param_str:
            param_str = param_str + "&"
...
class Host(LogicMonitor):
    ...
    def is_changed(self):
        ...
        hostresp = self.get_host_by_displayname(self.displayname) or self.get_host_by_hostname(self.hostname, self.collector)
